    ...
    ">
      ...
      <h2 style="margin:0; text-align:center; width:100%; margin-top:80px;">
        استمارة حصر عناصر التراث غير المادي
          ...
          <tr><th>1.4-	الموقع الطبيعي لعنصر التراث الثقافي غير المادي، ونطاق ممارسته ووتيرتها الموقع الجغرافي للعنصر</th><tr></tr>
              <td id="r_1_4"></td></tr>
      ...
      <table>
          ...
          <tr><th>3.7 قابلية استدامة عناصر التراث غير المادي الأخرى إن وجدت المرتبطة بالعنصر</th><tr></tr>
              <td id="r_3_7"></td></tr>
...
{id: 'q_3_1',
 ...
 example: ''},
  ...
  {id:'q_4_3',label:'4.3 تواريخ جمع المعلومات وأمكنتها',type:'textarea'},
  {id:'q_4_4',label:'4.4 الأشخاص المخبرون (الرواة/المزودون بالمعلومات) (أسماؤهم، ومكانتهم، وانتماؤهم)',type:'text', value:`الاسم:
العمر:
الجنس:
